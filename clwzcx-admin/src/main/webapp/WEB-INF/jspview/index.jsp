    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
		                   		 ...
		                   		 <li><a class="J_menuItem" href="sys/user/index">用户管理</li>
		                   		  <li><a class="J_menuItem" href="sys/car/index">车辆管理</li>
		                   		  <li><a class="J_menuItem" href="sys/peccancy/index">违章管理</li>
		                   		   <li><a class="J_menuItem" href="sys/peccancy/index">违章管理</li>
		                   		   <li><a class="J_menuItem" href="sys/article/index">新闻管理</li>
		                   		    <li><a class="J_menuItem" href="sys/article/create">发布新闻</li>
                        </ul>
                    </li>
                     </shiro:hasRole>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="" tppabs="" frameborder="0" data-id="tasktodo" seamless></iframe>
            </div>
            <div class="footer">
            </div>
        </div>
