            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="collapse navbar-collapse" id="main-menu">
                        <ul class="menu">
				        <li class="" role="presentation"><a href="${pageContext.request.contextPath}/index">首页</a></li>
				        <li class="" role="presentation"><a href="${pageContext.request.contextPath}/center">用户中心</a></li>
				        <li class="" role="presentation"><a href="${pageContext.request.contextPath}/car">车辆管理</a></li>
				          <li class="" role="presentation"><a href="${pageContext.request.contextPath}/wz">违章管理</a></li>
